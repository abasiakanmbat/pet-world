...
export default function Hero() {
    ...
    py-11' >
                <div className=' mx-auto py-10 px-5 md:py-0'>
                    <h1 className='w-fit mx-auto text-center md:text-left text-6xl md:text-[49px] lg:text-[75px] font-semibold  md:ml-[40px]' >Pet Store <br className='hidden md:block' /> & <br className='md:hidden' /> Beyond</h1>
